...
- `generated-obb` spike: `apps/editor/src/lib/content/footprint-generator.ts` (pure, dependency-free rotating-calipers OBB) + 6 unit tests; recovers the hand-authored piano 1.48 × 1.59 box from its outline points and passes the existing `validateAssetFootprint` gate. Not wired to runtime.
...
### R5 provisional depth decision — 2026-09-09 (pending post-F0 recheck; frozen only in R9)
...
### R6 provisional depth decision — 2026-09-09 (pending post-F0 recheck; frozen only in R9)
...
### R7 provisional depth decision — 2026-09-09 (pending post-F0 recheck; frozen only in R9)
