...
- Next: P22 shipped 2026-09-08 (P22.1–P22.5 + hosted acceptance — production
  ...
  **P23 Foundation Gate F0 passed 2026-09-10**; **stage-6 flip executed
  ...
  layout mutation `adapted`; cross-format transaction invariant enforced at
  commit; full gate green on the branch; commit `455f587` + safety-fix delta,
