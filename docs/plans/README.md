...
| P24 | Scene / Staging Depth umbrella — P24A asset supply + P24B Rich Scene / Staging Authoring | proposed — umbrella/research reconciliation; Pascal direct-reference harvest closed; active reconciliation sequence is R0–R9/B0–B6; **R0 post-F0 delta refresh complete 2026-09-10**; capability-specific placement/selection/support/persistence rechecks remain before R9 minimum freeze; implementation still depends on P23; P24A remains child seed/evidence pending | P23 | [umbrella](2026-09-08-P24-scene-staging-depth-umbrella.md) · [reconciliation](2026-09-09-P24-reconciliation-sequence.md) |
...
- Next: P23.1 in progress (post-F0 seam recheck passed 2026-09-10, no blockers); P24 R0 post-F0 delta refresh is complete, with only capability-specific placement/selection/support/persistence rechecks remaining toward the R9 minimum freeze; P24 implementation still waits for the accepted P23 minimum. Prior: P22 shipped 2026-09-08 (P22.1–P22.5 + hosted acceptance — production
