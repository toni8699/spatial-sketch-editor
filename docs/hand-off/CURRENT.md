...
- P21.6 closeout slice (3D camera visualization + viewport focus mode) approved for implementation 2026-09-07 — spec-only, unimplemented in tree (no camera palette tokens, no focus mode); registered in the tracker.
